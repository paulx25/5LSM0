...
def preprocess_masks(masks):
    transform = transforms.Compose([
        transforms.Resize((64, 128),transforms.InterpolationMode.NEAREST),
        transforms.ToTensor(),
    ])
...
def main(args):
    ...
    validationloader = DataLoader(val_data, batch_size=32, shuffle=True, num_workers=18, pin_memory=True)
