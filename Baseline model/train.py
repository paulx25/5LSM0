...
def main(args):
    ...
    trainloader = DataLoader(dataset, batch_size=64, shuffle=True, num_workers=18, pin_memory=True)
#    val = datasets.Cityscapes(args.data_path, split='train', mode='fine', target_type='semantic', transform=p.preprocess, target_transform=preprocess_masks2)
#    validationloader = DataLoader(val, batch_size=32, shuffle=True, num_workers=18, pin_memory=True)
